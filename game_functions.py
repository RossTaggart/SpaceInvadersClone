...
def start_new_level(ai_settings, screen, stats, sb, ship, aliens,
	bullets):
	"""Creates new level"""
	#Empties list of bullets and ups the speed of the next level
	bullets.empty()
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	#Space between each alien is equal to width of one alien
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""Check if the fleet is at an edge and then updates positions of aliens
	in the fleet."""
